 ...
 * @method static \Atomino\Carbon\Database\Finder\Comparison abstractTemplate($isin = null)
...
#[Validator("abstractTemplate", \Symfony\Component\Validator\Constraints\Length::class, ['max'=>65535])]
#[Field("abstractTemplate", \Atomino\Carbon\Field\StringField::class)]
...
abstract class _Event extends Entity {
	...
	public string|null $abstractTemplate = null;
